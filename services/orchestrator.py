...
class BandeiranteOrchestrator:
    ...
    async def investigacao_completa(
        ...
        logger.info(f"[BANDEIRANTE] Iniciando: {empresa}")
        ...
        try:
            ...
            logger.info(f"[BANDEIRANTE] Completo em {duration:.1f}s")
    ...
    async def _mapear_psicologia(self, results: Dict) -> Dict:
        ...
        storytelling = f"Pesquisei a {empresa} e vi que têm {area_total:,.0f} hectares. Como fazem rastreabilidade hoje?"
